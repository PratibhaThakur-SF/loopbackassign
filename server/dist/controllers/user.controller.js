...
let UserController = class UserController {
    ...
    async find(filter) {
        return this.userRepository.find({ include: ['role', 'customer'] });
    }
    async updateAll(user, where) {
        return this.userRepository.updateAll(user, where);
    }
    async findById(id, filter) {
        return this.userRepository.findById(id, { include: ['role', 'customer'] });
    }
...
tslib_1.__decorate([
    (0, core_1.intercept)('interceptors.LocalInterceptor'),
    (0, rest_1.get)('/users'),
    (0, rest_1.response)(200, {
